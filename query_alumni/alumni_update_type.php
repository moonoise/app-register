...
if (
    ...
    try {
        ...
        $stm->execute();
        $ku_id_auto =  $sqlConn->conn->lastInsertId();
        ...
        if (
            ...
            $stmCheck->bindParam(':ku_id_auto', $ku_id_auto);
            $stmCheck->execute();
            ...
            if ($stmCheck->rowCount()) {
                ...
                $stmUpdateAddress->bindParam(':ku_id_auto', $ku_id_auto);
                ...
                $stmInsertAddress->bindParam(':ku_id_auto', $ku_id_auto);
        ...
        $stmRegisterCheck->bindParam(':ku_id_auto', $ku_id_auto);
        ...
        if ($stmRegisterCheck->rowCount()) {
            ...
            $stmRegisterUpdate->bindParam(':ku_id_auto', $ku_id_auto);
            ...
            $stmRegisterInsert->bindParam(':ku_id_auto', $ku_id_auto);
