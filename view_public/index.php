...
<body class="d-flex flex-column h-100 bg-premium-dark">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="position-relative form-group"><label for="training_name"
                                                ...
                                                class="form-control"
                                                value="ร่วมประชุมสัมมนาการเตรียมการจัดทำงบประมาณรายจ่ายประจำปีงบประมาณ พ.ศ. ๒๕๖๕"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="position-relative form-group">
                                            <label for="title_name" class=""><span class="text-danger">*</span> <small
                                                    class="text-primary">คำนำหน้าชื่อ</small>
                                                : </label>
    ...
    <footer class="footer mt-auto py-3 bg-premium-dark">
        <div class="container">
            <span class="text-muted text-color-white">สงวนลิขสิทธิ์ : ระบบลงทะเบียนอบรม ออนไลน์ สำนักงบประมาณ
