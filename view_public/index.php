    ...
    <main role="main" class="flex-shrink-0 mt-3">
        <div class="container">
            <div class="card col-12">
                <div class="card-body">
                    <div class="">
                        <img src="../assets/images/logo_bb.png" alt="" srcset="" class="card-img-top">
                    </div>
                        ...
                        <div id="div-form">
                            <form class="" name="form_alumni" id="form_alumni">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="position-relative form-group"><label for="training_name" class=""><span class="text-danger">*</span> ชื่อหลักสูตร</label><input name="training_name" id="training_name" placeholder="" type="text" class="form-control" value="ร่วมประชุมสัมมนาการเตรียมการจัดทำงบประมาณรายจ่ายประจำปีงบประมาณ พ.ศ. ๒๕๖๕" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="position-relative form-group">
                                            <label for="title_name" class=""><span class="text-danger">*</span> <small class="text-primary">คำนำหน้าชื่อ</small>
                                                : </label>
                                            <select name="title_name_th" id="title_name_th" class="mb-2 form-control">
                                                <option value=""></option>
                                    ...
                                    <div class="col-md-5">
                                        <div class="position-relative form-group"><label for="fname_th" class=""><span class="text-danger">*</span> ชื่อ</label><input name="fname_th" id="fname_th" placeholder="" type="text" class="form-control"></div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="position-relative form-group"><label for="lname_th" class=""><span class="text-danger">*</span> สกุล</label><input name="lname_th" id="lname_th" placeholder="" type="text" class="form-control"></div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="position-relative form-group"><label for="position" class="">ตำแหน่ง: </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group"><label for="level" class="">ระดับ:
                                            ...
                                            <input name="level" id="level" placeholder="" type="text" class="form-control">
                                        </div>
                                    </div>

                                    <div class="col-md-12">
                                        <div class="position-relative form-group"><label for="org_id_root" class="">กระทรวง:
                                            </label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="mobile" id="mobile" placeholder="" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                ...
                                <div class="mt-4 d-flex align-items-center">
                                    ...
                                    <div class="ml-auto">
                                        <button id="btn-register" class="btn-wide btn-pill btn-shadow btn-hover-shine btn btn-primary btn-lg">ลงทะเบียน
                                        </button>
                                    </div>
                                </div>
                            </form>
    ...
    <script>
                ...
                success: function(response) {
                    if (response.success == false) {
                        Swal.fire({
                            ...
                            text: 'สังกัดที่ท่านเหลือ มีการทะเบียนไว้แล้ว กรุณาติดต่อเจ้าหน้าที่ หากมีข้อสงสัย',
                            type: 'error',
        ...
        $("#form_alumni").validate({
            ...
            messages: {
                ...
                email: "โปรดกรอกข้อมูล email เพื่อใช้ส่งข่าวสารให้ครับศิษย์เก่า",
