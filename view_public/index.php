                        ...
                        <div id="div-form">
                            <form class="" name="form_alumni" id="form_alumni">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="position-relative form-group"><label for="training_name" class=""><span class="text-danger">*</span> ชื่อหลักสูตร</label><input name="training_name" id="training_name" placeholder="" type="text" class="form-control" value="การเตรียมการจัดทำงบประมาณรายจ่ายประจำปีงบประมาณ พ.ศ. ๒๕๖๕" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="title_name_th" id="title_name_th" placeholder="" type="text" class="form-control">
