            ...
            success: function(response) {
                if (response.success == false) {
                    Swal.fire({
                        ...
                        text: 'สังกัดที่ท่านเหลือ มีการทะเบียนไว้แล้ว กรุณาติดต่อเจ้าหน้าที่  เบอร์โทร 0-2265-2202 คุณณัฏฐพล, เบอร์โทร 0-2265-1759 คุณปัณฑิต์ยา, เบอร์โทร 0-2265-1756 คุณดวงนภา',
                        type: 'error',
