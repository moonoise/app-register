                ...
                <div class="h-100 no-gutters row">
                    <div
                        ...
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            <div class="">
                                <img src="../assets/images/logo_alumni.png" alt="" srcset="" class="logo-irrigation">
                            </div>
                            <h4>
                                <div>
                                    <h5 class="text text-danger">ยินดีตอนรับ สมาคมศิษย์เก่าวิศวกรรมชลประทาน
                            ...
                            <div>
                                <form class="form-inline">
                                    <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group "><label
                                            for="id_search" class="mr-sm-2"><span class="text text-success"> ค้นหา
                                            </span> </label><input name="id_search" id="id_search"
                                            placeholder="ชื่อ-สกุล,เลขชลกร,รหัสนักศึกษา" type="text"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="exampleName"
                                                    class="">Name</label><input name="text" id="exampleName"
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="examplePasswordRep"
                                                    ...
                                                    Password</label><input name="passwordrep" id="examplePasswordRep"
