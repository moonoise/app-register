        ...
        <div class="app-main">
            <div class="col-12">
                ...
                <div class="col-sm-3 col-xl-3">
                    ...
                    <div class="col-sm-3 col-xl-3">
                        <button class="btn-icon-vertical mb-3 btn-transition btn-block btn btn-outline-info"><i class="lnr-heart btn-icon-wrapper"> </i><span class="badge badge-warning badge-dot badge-dot-inside"> </span><h3>นิสิต</h3>
                        </button>
                    </div>
                    <div class="col-sm-3 col-xl-3">
                        <button class="btn-icon-vertical mb-3 btn-transition btn-block btn btn-outline-warning"><i class="lnr-magic-wand btn-icon-wrapper"> </i><span class="badge badge-info badge-dot badge-dot-lg badge-dot-inside"> </span><h3>อาจารย์</h3>
                        </button>
                    </div>
                    <div class="col-sm-3 col-xl-3">
