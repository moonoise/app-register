                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading"><b class="pr-2">ID No:</b><b class="text-success" id="id-student_id"></b> </div>
        ...
        function show_profile(std_id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#id-student_id").html(response.data.std_id);
                    $("#id-name").html(response.data.std_fname + " " + response.data.std_lname)
