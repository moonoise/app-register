...
<body>
    ...
    <script>
        ...
        function student_analytics_future(std_id) {
            $.ajax({
                type: "POST",
                url: "../query/student_analytics_future.php",
                data: {
                    'std_id': std_id
                },
                dataType: "JSON",
                ...
                if (this.permissible == true) {
                    ...
                    if (this.registered == true) {
                        if (grade.includes(this.grade_text)) {
                            ...
                            strGrade = "<button type=\"button\" class=\"btn-check-grade btn-icon btn-shadow btn-dashed btn btn-outline-warning\" ></button>"
                        } else {
                            strGrade = "<button type=\"button\" class=\"btn-check-grade btn-icon btn-shadow btn-dashed btn btn-outline-success\" > " + this.grade_text + "</button>"
                        }
                    }
                } else {
