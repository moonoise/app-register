                        ...
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xl-4 mx-auto">
                                    <button class="btn-icon-vertical mb-3 btn-transition btn-block btn btn-outline-primary" onclick="window.location.href='../view_admin'">
                                        <i class="lnr-license btn-icon-wrapper"> </i>
                                        <span class="badge badge-primary badge-dot badge-dot-sm badge-dot-inside"> </span> เฉพาะอาจารย์และเจ้าหน้าที่
                                    </button>
                                </div>
                            </div>
