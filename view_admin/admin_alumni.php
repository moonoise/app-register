...
<body>
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <button type="button" class="btn mr-2 mb-2 btn-primary" data-toggle="modal"
                                                data-target=".bd-new-modal-lg"><i
                                                    class="pe-7s-news-paper btn-icon-wrapper"></i> New</button>
                                        </div>
                                        <div class="col-9">
                                            <div class="form-row">
                                                <form action="" class="form-inline" name="form_select_std"
                                                    id="form_select_std">
                                                    <div class="mb-2 mr-sm-2 mb-sm-0 position-relative form-group">
                                                        <label for="select_yt_year"
                                                            class="mr-sm-2">เลือกรุ่นนิสิต(Batch)</label>
                                        ...
                                        <div class="col-12">
                                            <table style="width: 100%;" id="table_teacher_subject"
                                                class="table table-hover table-striped table-bordered for-this-table">
                                                <thead>
                                                    <tr class="text-center">
                                                        <th scope="col" class="text-center fa">#</th>
                                                        <th scope="col" class="text-center">ปีการศึกษา(รุ่น)</th>
                                                        <th scope="col" class="text-center">ชื่อ - สกุล <span
                                                                class="text text-danger">(ชื่อเก่า)</span></th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="" name="form_student_edit" id="form_student_edit">
                        ...
                        <div class="form-row">
                            <div class="col-md-3">
                                <div class="position-relative form-group"><label for="std_id_edit"
                                        class="">รหัสนักศึกษา</label>
                                    <input name="std_id_edit" id="std_id_edit" placeholder="รหัสนักศึกษา" type="text"
                                        class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="position-relative form-group"><label for="std_id_card_edit"
                                        class="">บัตรประชาชน</label><input name="std_id_card_edit" id="std_id_card_edit"
                                        placeholder="บัตรประชาชน" type="text" class="form-control"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="position-relative form-group"><label for="std_year_edit"
                                        class="">ปีการศึกษาที่เข้าเรียน</label>
                        ...
                        <div class="form-row">
                            <div class="col-md-2">
                                <div class="position-relative form-group"><label for="std_title_name_edit"
                                        class="">คำนำหน้า</label>
                                    <select class="mb-2 form-control" name="std_title_name_edit"
                                        id="std_title_name_edit">
                            ...
                            <div class="col-md-4">
                                <div class="position-relative form-group"><label for="std_fname_edit"
                                        class="">Name</label><input name="std_fname_edit" id="std_fname_edit"
                                        placeholder="ภาษาอังกฤษ" type="text" class="form-control"></div>
                            </div>
                            <div class="col-md-4">
                                <div class="position-relative form-group"><label for="std_lname_edit"
                                        class="">Surname</label><input name="std_lname_edit" id="std_lname_edit"
                                        placeholder="ภาษาอังกฤษ" type="text" class="form-control"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-2">
                                <div class="position-relative form-group"><label for="std_title_name_edit"
                                        class="">คำนำหน้า</label>
                                    <select class="mb-2 form-control" name="std_title_name_th_edit"
                                        id="std_title_name_th_edit">
                            ...
                            <div class="col-md-4">
                                <div class="position-relative form-group"><label for="std_fname_th_edit"
                                        class="">ชื่อ</label><input name="std_fname_th_edit" id="std_fname_th_edit"
                                        placeholder="ภาษาไทย" type="text" class="form-control"></div>
                            </div>
                            <div class="col-md-4">
                                <div class="position-relative form-group"><label for="std_lname_th_edit"
                                        class="">สกุล</label><input name="std_lname_th_edit" id="std_lname_th_edit"
                                        placeholder="ภาษาไทย" type="text" class="form-control"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="position-relative form-group"><label for="admission_type_edit"
                                        class="">มาจากโครงการ...</label>
                                    <select class="mb-2 form-control" name="admission_type_edit"
                                        id="admission_type_edit">
    ...
    <!-- modal-new subject -->
    <div class="modal fade bd-new-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form class="" name="form_student_add" id="form_student_add">
                        <div class="form-row">
                            <div class="col-md-3">
                                <div class="position-relative form-group"><label for="std_id_add"
                                        class="">รหัสนักศึกษา</label><input name="std_id_add" id="std_id_add"
                                        placeholder="รหัสนักศึกษา" type="text" class="form-control"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="position-relative form-group"><label for="std_id_card_add"
                                        class="">บัตรประชาชน</label><input name="std_id_card_add" id="std_id_card_add"
                                        placeholder="บัตรประชาชน" type="text" class="form-control"></div>
                            </div>
                            <div class="col-md-3">
                                <div class="position-relative form-group"><label for="std_year_add"
                                        class="">ปีการศึกษาที่เข้าเรียน</label>
                        ...
                        <div class="form-row">
                            <div class="col-md-2">
                                <div class="position-relative form-group"><label for="std_title_name_add"
                                        class="">คำนำหน้า</label>
                            ...
                            <div class="col-md-4">
                                <div class="position-relative form-group"><label for="std_fname_add"
                                        class="">Name</label><input name="std_fname_add" id="std_fname_add"
                                        placeholder="ภาษาอังกฤษ" type="text" class="form-control"></div>
                            </div>
                            <div class="col-md-4">
                                <div class="position-relative form-group"><label for="std_lname_add"
                                        class="">Surname</label><input name="std_lname_add" id="std_lname_add"
                                        placeholder="ภาษาอังกฤษ" type="text" class="form-control"></div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2">
                                <div class="position-relative form-group"><label for="std_title_name_add"
                                        class="">คำนำหน้า</label>
                                    <select class="mb-2 form-control" name="std_title_name_th_add"
                                        id="std_title_name_th_add">
                                        <option value="นาย">นาย</option>
                                        <option value="นางสาว">นางสาว</option>
                                        <option value="นาง">นาง</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="position-relative form-group"><label for="std_fname_th_add"
                                        class="">ชื่อ</label><input name="std_fname_th_add" id="std_fname_th_add"
                                        placeholder="ภาษาไทย" type="text" class="form-control"></div>
                            </div>
                            <div class="col-md-4">
                                <div class="position-relative form-group"><label for="std_lname_th_add"
                                        class="">สกุล</label><input name="std_lname_th_add" id="std_lname_th_add"
                                        placeholder="ภาษาไทย" type="text" class="form-control"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="position-relative form-group"><label for="admission_type_add"
                                        class="">มาจากโครงการ...</label>
